...
%post
    ...
    #Rscript -e 'r = getOption("repos"); r["CRAN"] = "https://cran.rstudio.com/"; options(repos = r); source("https://bioconductor.org/biocLite.R"); Bio$
    Rscript -e 'install.packages("devtools", dependencies = TRUE, repos = "https://cran.rstudio.com"); library(devtools); devtools::install_github("bioF$
    ##
%test
    R --version
